...
([
    function(t,n,e)
        {
        "use strict";
        var r=e(1);t.exports=r,window.Choreographer=r
        },
        ...
        var o=function()
            ...
            return function(n,e,r)
                ...
                return o
                    (t,
                        [
                            {key:"getAnimationFn",value:function(t)
                            {
                            return s[t]||this.customFunctions[t]||a
                            }
                            },
                            {key:"updateAnimations",value:function(t)
                                {
                                var n=this;this.animations=t.map(function(t)
                                    {
                                    return t.fn=n.getAnimationFn(t.type),new i(t)
                                    })
                                }
                            },
                            {key:"runAnimationsAt",value:function(t)
                                {
    ...
    function(t,n)
        ...
        s=function()
            ...
            return i(t,[
                {key:"storeNodes",value:function()
                    {
                    var t=this;this.config.selector&&(this.nodes=Array.prototype.slice.call(document.querySelectorAll(this.config.selector))),this.config.selectors&&(this.nodes=[],this.config.selectors.forEach(function(n)
                        {
                        var e=Array.prototype.slice.call(document.querySelectorAll(n));t.nodes=t.nodes.concat(e)
                        }))
                    }
                },
                {key:"getProgress",value:function(t,n)
                    {
                    var e=o(n,2),r=e[0],i=e[1];
                    return(t-r)/(i-r)
                    }
                },
                {key:"getProgressAt",value:function(t)
                    {
                    ...
                    {key:"runAt",value:function(t)
                        ...
                        if(e<0||e>1)
                            ...
                            r)
                            return;"change"===this.config.type&&(e=-1),"scale"===this.config.type&&(e<0&&(e=0),e>1&&(e=1))
                            }
                        this.nodes.forEach(function(t)
                            {
                            e>0&&e<1&&t.setAttribute("animated",t.getAttribute("animated")+"|"+n.config.style),n.config.fn({node:t,style:n.config.style,from:n.config.from,to:n.config.to,unit:n.config.unit,progress:e})
                            })
                        }
                    }])
                ,t
            ...
            t.exports={scale:o,change:i}},function(t,n)
                {
                "use strict";
                var e={translateX:0,translateY:1,translateZ:2},r={scaleX:0,scaleY:1,scaleZ:2},o={transform:"transform",webkitTransform:"-webkit-transform",MozTransform:"-moz-transform",msTransform:"-ms-transform",OTransform:"-o-transform"},i=function()
                    {
                    ...
                    return document.body.removeChild(t),null},s=function()
                {if(!a)
                    return!1;
                var t=document.createElement("div");
                ...
                a=i(),u=s(),f=function(t,n,o)
                    {
                    if(a)
                        {var i=t.style[a]||"",s=void 0,f=void 0,c=void 0;if(u&&(void 0!==e[n]?(f=e[n],n="translate3d",c=["0","0","0"],null===o&&(o=0)):void 0!==r[n]&&(f=r[n],n="scale3d",c=["1","1","1"],null===o&&(o=1)),void 0!==f))
                            {
                            if(i.indexOf(n)>-1)
                                {
